...
# read geometry
        ...
        if len(tokens) == 1:
           ...
           for i in range(numAtoms):
        	...
        	if (int(tokens[1])== 6): self.Mass[j]=12.0
        	if (int(tokens[1])== 8): self.Mass[j]=15.99491
        	if (int(tokens[1])== 1): self.Mass[j]=1.00783
        	if (int(tokens[1])== 7): self.Mass[j]=14.0031
        	if (int(tokens[1])== 17): self.Mass[j]=34.96885
        	if (int(tokens[1])== 16): self.Mass[j]=31.97207
        	if (int(tokens[1])== 9): self.Mass[j]=18.99840
